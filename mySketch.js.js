//IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL
//IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL
//IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL IMAGE CAROUSEL
...
function setup() {
	...
	main_buttons[0].onPress = function () {
		if(errors >= 10){print("YOU'VE BEEN KICKED OUT OF THIS FUNCTION");}
		else{ ram();}
	}
  ...
  sentenceList.push(act)
	...
	} else if (objects){ //OBJECT POEM GAMES	
		fill(0, 102, 153);
		noStroke();
		rect(150, 20, 600, 450);
...
function draw() {
	...
	//RAM ELEMENTS RAM ELEMENTS RAM ELEMENTS
	//RAM ELEMENTS RAM ELEMENTS RAM ELEMENTS
	if(RAM){
		resetScreen();
		intro = false;
	    ...
	    if(keyIsPressed && sentence.length >0){start = true;}
	...
	//JOURNAL ELEMENTS JOURNAL ELEMENTS
	//JOURNAL ELEMENTS JOURNAL ELEMENTS
	if(JOURNAL){
		clear();
		resetScreen();
	...
	//GAME ELEMENTS GAME ELEMENTS GAME ELEMENTS
	//GAME ELEMENTS GAME ELEMENTS GAME ELEMENTS
	if(GAMES){
		clear();
		resetScreen();
	...
	//MECH ELEMENTS MECH ELEMENTS MECH ELEMENTS
	//MECH ELEMENTS MECH ELEMENTS MECH ELEMENTS
	if(MECH){
		clear();
		resetScreen();
	...
	//PIECES ELEMENTS PIECES ELEMENTS PIECES
	//PIECES ELEMENTS PIECES ELEMENTS PIECES
	if(PIECES){
		clear();
		resetScreen();
...
//RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION
//RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION
//RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION RAM FUNCTION
...
//JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION
//JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION
//JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION JOURNAL FUNCTION
function journal() {
	RAM = false;
...
//GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION
//GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION
//GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION GAMES FUNCTION
function games() {
	RAM = false;
...
//MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION
//MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION
//MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION MECH FUNCTION
function mech() {
	RAM = false;
...
//PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES
//PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES
//PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES FUNCTION PIECES
function pieces() {
	RAM = false;
